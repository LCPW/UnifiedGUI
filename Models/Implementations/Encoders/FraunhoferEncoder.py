...
class FraunhoferEncoder(EncoderInterface):
    ...
    def parameters_edited(self):
        ...
        """
        self.frequency = int(self.parameter_values['frequency [Hz]'])
        ...
        if self.modulation == "CSK" and self.burst_per_val*(self.modulation_index-1)*(1/self.frequency) > self.symbol_interval:
